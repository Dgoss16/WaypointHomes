    ...
    req.app.get('db').create_appointment([propertyAddress, first, last, phone, email, income, eviction, bankruptcy, credit, appointmentDate, appointmentTime, code]).then(()=>{
        var mailOptions = {
            ...
            html: `<h1>Self-Showing Created!</h1>
                   ...
                   <p>When you arrive at the house, notice the keypad on the front door. Your keypad will have either a star symbol or checkmark symbol in the bottom left corner.Enter your code:${req.body.code} then press the satr or checkmark key. Open Sesame!</p>
